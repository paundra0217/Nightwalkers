...
class AudioObject
{
    ...
    [Tooltip("Audio name that later will be played using PlayBGM() or PlaySFX() function, depend on the audio type")]
    public string AudioName;
    
    [Tooltip("The type of audio, wether be BGM or SFX")] 
...
public class AudioController : MonoBehaviour
{
    ...
    [SerializeField]
    [Tooltip("List of audio that will be played")]
    private AudioObject[] audios;
